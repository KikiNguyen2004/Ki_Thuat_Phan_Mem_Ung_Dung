...
public class EmployeeManagementView extends JFrame {
    public JComboBox<String> employeeIDBox;
    ...
    public EmployeeManagementView() {
        ...
        JLabel employeeIDBoxLabel = new JLabel("Employee ID:");
        gbc.gridx = 0;
        gbc.gridy = 0;
        mainPanel.add(employeeIDBoxLabel, gbc);

        employeeIDBox = new JComboBox<>();
        employeeIDBox.setPreferredSize(new Dimension(200, 30));
        gbc.gridx = 1;
        mainPanel.add(employeeIDBox, gbc);
